            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  ...
                  <p className="opacity-80">Thank you for your purchase. Your order will be processed shortly.</p>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="p-8 md:p-12 rounded-3xl backdrop-blur-xl bg-white/10 border border-white/20">
                  ...
                  <button type="submit" className="mt-10 w-full py-4 bg-white text-black rounded-full font-bold uppercase tracking-widest hover:bg-zinc-200 transition-colors">
                    Confirm Order
                  </button>
                </form>
              )}
